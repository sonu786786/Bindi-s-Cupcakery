    ...
    <div className="bg-white text-gray-900">
      ...
      <section className="py-16 bg-gradient-to-b from-pink-50 to-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="sechead">Why Choose Bindi’s Cupcakery?</h2>
          <br />
            ...
            {[
              {
                ...
                description:
                  "Enjoy homemade treats made with natural ingredients, completely eggless and free from preservatives.",
                img: "/cake.png",
              },
              {
                title: "Wide Range of Desserts",
                description:
                  "From ice creams to cupcakes, brownies, and cakes, we offer a variety of delicious options for every craving.",
                img: "/sweets.png",
              },
              {
                title: "Customizable Hampers",
                description:
                  "Personalize dessert hampers for birthdays, weddings, and special occasions.",
                img: "/hamper.png",
              },
              {
                title: "Seamless Ordering",
                description:
                  "Scan our WhatsApp QR code to place an order instantly and enjoy quick pickups from our cloud kitchen.",
                img: "/order.png",
              },
            ].map((item, index) => (
              <div
